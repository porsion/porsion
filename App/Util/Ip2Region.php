...
class Ip2Region
{
    ...
    public function __construct($ip2regionFile = null)
    {
        ...
        $this->dbFile = is_null($ip2regionFile) ? EASYSWOOLE_ROOT . '/ip2region.db' : $ip2regionFile;
        if (!is_file($this->dbFile)) {
            throw new \RuntimeException($this->dbFile .' not exists!');
        }
    }
